                            ...
                            <div className="space-y-1">
                                ...
                                )}
                                {
                                    ...
                                    <NavLink 
                                        ...
                                        <div className={`h-6 w-6 rounded-full bg-gray-300 mr-2 flex-shrink-0 flex items-center justify-center  text-xs ${
                                            client.id === clientId ? 'bg-primary/10 text-blue-500 font-medium' : 'bg-gray-300'
                                        }`}>
