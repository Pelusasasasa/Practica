        ...
        <div className="flex justify-around items-center">
          ...
          <div className="flex-col w-[500px]">
            ...
            <Controller
              ...
              rules={{required: true}}
              render={({field}) => (
                <Input className="mt-2" type="text" value={field.value} onChange={field.onChange} label="Titulo del producto" />
              )}
            />
            ...
            <Controller
              ...
              rules={{required: true}}
              render={({field}) => (
                <Input className="mt-2" value={field.value?.toString()} onChange={field.onChange} type="number" label="Precio del producto" />
              )}
            />
            ...
            <Controller
              ...
              rules={{required: true}}
              render={({field}) => (
                <Input className="mt-2" value={field.value} onChange={field.onChange} type="url" label="Url del producto" />
              )}
            />
